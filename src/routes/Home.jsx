...
const Home = () => {
  ...
  return (
    <div className="mx-auto md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-14 overflow-clip">
      ...
      <HeroSimple
        title="Start Bumping!"
        description="From local friend parties and reunions to tech founder meetups and company meetings, Bump has your back. Literally."
      />
      <Workflows />

      <HeroEnd title="Become a Bumper now!" />
      <Footer />
      <AuthModal
        title={modalTitle}
        show={showModal}
